...
class QNetwork(BaseNetwork):
    def __init__(self, no_obs, num_actions, hidden_units=[256, 256],
                 initializer='xavier'):
        super(QNetwork, self).__init__()
        self.Q = create_linear_network(
            no_obs + num_actions, 1, hidden_units=hidden_units,
...
class TwinnedQNetwork(BaseNetwork):
    ...
    def __init__(self, no_obs, num_actions, hidden_units=[256, 256],
        ...
        self.Q1 = QNetwork(
            no_obs, num_actions, hidden_units, initializer)
        self.Q2 = QNetwork(
            no_obs, num_actions, hidden_units, initializer)
...
class GaussianPolicy(BaseNetwork):
    ...
    def __init__(self, no_obs, num_actions, hidden_units=[256, 256],
        ...
        self.policy = create_linear_network(
            no_obs, num_actions * 2, hidden_units=hidden_units,
            initializer=initializer)
